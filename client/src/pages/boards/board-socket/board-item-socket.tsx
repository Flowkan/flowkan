...
type DragStartedPayload = Parameters<ServerToClientEvents["board:dragstarted"]>[0];

type DragShowCoordsPayload = Parameters<ServerToClientEvents["board:dragshowcoords"]>[0];

type DragUpdatedPayload = Parameters<ServerToClientEvents["board:dragupdated"]>[0];

type DragFailedPayload = Parameters<ServerToClientEvents["board:dragfailed"]>[0];
