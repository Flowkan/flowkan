...
export default class NotificationThumbnailHandler{
    ...
    private listenToAppEvents() {
        appEvents.on('thumbnail:processing', this.handleThumbnailLoading.bind(this));
        appEvents.on('thumbnail:completed', this.handleThumbnailComplete.bind(this));
        // appEvents.on('thumbnail:error', this.handleThumbnailError.bind(this));
        
        console.log("NotificationThumbnailHandler is listening to app events.");
    }
}