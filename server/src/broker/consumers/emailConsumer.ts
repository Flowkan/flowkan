...
import { generateConfirmationEmailTemplate, generatePasswordResetEmailTemplate, generateWelcomeEmailTemplate } from "../../services/TemplateEmailService";
...
async function processEmailMessage(
  ...
  try {
    ...
    console.error(`[Consume: Email] Fallo de procesamineto. Enviado a DLQ`,error);
