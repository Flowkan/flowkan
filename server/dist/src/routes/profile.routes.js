...
router.patch("/:userId", jwtAuth.guard, uploadConfigure_1.upload.single("photo"), (0, uploadConfigure_1.processImage)("users", { original: {}, thumb: { width: 100, height: 100 } }, "photo"), controller.partial);
